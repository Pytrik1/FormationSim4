...
class Controller:
    ...
    def __init__(self):
        ...
        # prepare publisher
        self.pub = rospy.Publisher('/n_2/cmd_vel', Twist, queue_size=1)
        self.velocity = Twist()
                
        # subscribe to z_values topic
        rospy.Subscriber('/n_2/z_values', numpy_msg(Floats), self.controller)
    ...
    def update_controller_variables(self, data):
        ...
        if self.running < 10:
            ...
            #self.dd = np.float32(self.controller_variables[2]*1.02)
    ...
    def controller(self, data):
        ...
        if self.running < 10:
            ...
            p12 = np.array([[z_values[1]], [z_values[2]]])
            p42 = np.array([[z_values[4]], [z_values[5]]])
            p32 = np.array([[z_values[7]], [z_values[8]]])
