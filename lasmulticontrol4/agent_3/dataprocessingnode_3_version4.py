    ...
    def calculate_r(self, msg):
        ...
        if self.running:
            ...
            if self.k == 2: # tracking state
                ...
                print '------------------------------------------------'
                print 'dist to Nexus 2 = ', round(self.r_values[0], 2), self.robots[0][1]
                print 'dist to Nexus 1 = ', round(self.r_values[3], 2), self.robots[1][1]
                print 'dist to Nexus 4 = ', round(self.r_values[6], 2), self.robots[2][1]
                print '------------------------------------------------'
